...
public class GetUserStoryTaskTests
{
    ...
    public GetUserStoryTaskTests()
    {
        ...
        _dataTransferServiceMock.Setup(x => x.SetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItemsUserStories, It.IsAny<string>()))
    ...
    public async Task ExecuteAsync_WithEmptyRedisData_ShouldNotWriteToRedis()
    {
        ...
        _dataTransferServiceMock.Setup(x => x.GetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItems))
        ...
        _dataTransferServiceMock.Verify(x => x.SetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItemsUserStories, It.IsAny<string>()), Times.Never);
    }
    ...
    public async Task ExecuteAsync_WithUserStoryWorkItem_ShouldReturnAlreadyUserStoryOrAbove()
    {
        ...
        // Assert
        _dataTransferServiceMock.Verify(x => x.SetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItemsUserStories, It.IsAny<string>()), Times.Once);
