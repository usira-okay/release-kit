...
public class GetUserStoryTaskTests
{
    ...
    public GetUserStoryTaskTests()
    {
        ...
        _dataTransferServiceMock.Setup(x => x.HashSetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItemsUserStories, It.IsAny<string>()))
    ...
    public async Task ExecuteAsync_WithEmptyRedisData_ShouldNotWriteToRedis()
    {
        ...
        _dataTransferServiceMock.Setup(x => x.HashGetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItems))
        ...
        _dataTransferServiceMock.Verify(x => x.HashSetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItemsUserStories, It.IsAny<string>()), Times.Never);
    }
    ...
    public async Task ExecuteAsync_WithUserStoryWorkItem_ShouldReturnAlreadyUserStoryOrAbove()
    {
        ...
        // Assert
        _dataTransferServiceMock.Verify(x => x.HashSetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItemsUserStories, It.IsAny<string>()), Times.Once);
