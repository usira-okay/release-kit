...
public class GetReleaseSettingTaskTests
{
    ...
    {
        // Arrange
        _dataTransferServiceMock.Setup(x => x.HashGetAsync(RedisKeys.GitLabHash, RedisKeys.Fields.ReleaseBranches))
            .ReturnsAsync((string?)null);
        _dataTransferServiceMock.Setup(x => x.HashGetAsync(RedisKeys.BitbucketHash, RedisKeys.Fields.ReleaseBranches))
            .ReturnsAsync((string?)null);
