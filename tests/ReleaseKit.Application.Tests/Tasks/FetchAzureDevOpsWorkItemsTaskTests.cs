...
public class FetchAzureDevOpsWorkItemsTaskTests
{
    ...
    public async Task ExecuteAsync_WithNoVSTSIdInTitle_ShouldNotWriteToRedis()
    {
        ...
        _dataTransferServiceMock.Verify(x => x.HashSetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItems, It.IsAny<string>()), Times.Never);
    }
    ...
    {
        _dataTransferServiceMock.Setup(x => x.HashDeleteAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItems))
            .ReturnsAsync(true);
        ...
        _dataTransferServiceMock.Setup(x => x.HashSetAsync(RedisKeys.AzureDevOpsHash, RedisKeys.Fields.WorkItems, It.IsAny<string>()))
    ...
    {
        _dataTransferServiceMock.Verify(x => x.HashSetAsync(
