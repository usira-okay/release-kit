...
public class FetchAzureDevOpsWorkItemsTaskTests
{
    ...
    public async Task ExecuteAsync_WithNoVSTSIdInTitle_ShouldNotWriteToRedis()
    {
        ...
        _dataTransferServiceMock.Verify(x => x.SetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItems, It.IsAny<string>()), Times.Never);
    }
    ...
    {
        _dataTransferServiceMock.Setup(x => x.DeleteFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItems))
            .ReturnsAsync(true);
        ...
        _dataTransferServiceMock.Setup(x => x.SetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItems, It.IsAny<string>()))
    ...
    {
        _dataTransferServiceMock.Verify(x => x.SetFieldAsync(
        ...
        _dataTransferServiceMock.Invocations
            .Where(i => i.Method.Name == nameof(IDataTransferService.SetFieldAsync))
