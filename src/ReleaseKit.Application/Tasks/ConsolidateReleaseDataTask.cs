...
public class ConsolidateReleaseDataTask : ITask
{
    ...
    {
        var bitbucketJson = await _dataTransferService.GetFieldAsync(DataTransferKeys.BitbucketHash, DataTransferKeys.Fields.PullRequestsByUser);
    ...
    {
        var json = await _dataTransferService.GetFieldAsync(DataTransferKeys.AzureDevOpsHash, DataTransferKeys.Fields.WorkItemsUserStories);
