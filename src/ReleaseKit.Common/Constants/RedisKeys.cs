...
public static class RedisKeys
{
    ...
    /// <summary>
    /// Azure DevOps User Story 團隊映射後的 Work Items 資料的 Redis Key
    /// </summary>
    public const string AzureDevOpsUserStoryTeamMappedWorkItems = "AzureDevOps:WorkItems:UserStories:TeamMapped";
}
